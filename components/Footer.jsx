      ...
      <div className='flex flex-col'>
        ...
        <div className='flex items-center justify-between flex-wrap gap-4'>
          ...
          <div className='flex gap-4 '>
            {socials.map((social)=>(
            <Link href="https://priyanshgupta2002.github.io/personal/"> <img src={social.url} alt={social.name} key={social.name} className="w-[24px] h-[24px] object-contain cursor-pointer" /></Link>
            ))}
          </div>
        </div>
      </div>
